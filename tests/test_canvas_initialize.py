...
class TestCanvasInitialize:
    ...
    def test_render_text_canvas_canvas(self) -> None:
        ...
        # Test
        render_text_canvas(app, initialize_webhook)

        # Verify
        app.benchling.apps.create_canvas.assert_called_once_with(
            expected_canvas_builder.to_create()
        )
